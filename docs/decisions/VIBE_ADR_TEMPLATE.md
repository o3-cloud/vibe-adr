...
What should this _feel_ like when done right?  
...
- **Anti-Goals**
  - {Outcome(s) explicitly not in scope; e.g., "do not add new services"}
  - {Scope intentionally excluded}
- **Guardrails**
  - {Hard constraints or invariants; e.g., "remain backwards compatible"}
  - {Safety, compliance, or vibe boundaries}
...
_(Used for automation and summarization)_
